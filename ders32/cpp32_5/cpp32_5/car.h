...
public:
	void start() override// burada fonk basýnda virtual olsa da olmasada bu virtualdir imlicit olarak
	{
...
car* create_random_car()
{
	...
	static std::uniform_int_distribution dist{ 0,7 };  //cpp yeni standartlar
	...
	case 7:std::cout << "volvý xc90...."; return new VolvoXC90 ;
	}
	return nullptr;
